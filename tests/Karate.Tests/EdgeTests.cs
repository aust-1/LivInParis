namespace Karate.Tests
{
    ...
    {
        private readonly Node<string> _node1 = Node<string>.GetOrCreateNode("Node1");
        private readonly Node<string> _node2 = Node<string>.GetOrCreateNode("Node2");
        ...
        {
            var edge = new Edge<string>(_node1, _node2, 2.5, true);
        ...
        {
            var edge1 = new Edge<string>(_node1, _node2);
            var edge2 = new Edge<string>(_node1, _node2);
        ...
        {
            var edge1 = new Edge<string>(_node1, _node2, isDirected: true);
            var edge2 = new Edge<string>(_node2, _node1, isDirected: true);
        ...
        {
            var edge1 = new Edge<string>(_node1, _node2, 1.0, false);
            var edge2 = new Edge<string>(_node2, _node1, 1.0, false);
        ...
        {
            var edge1 = new Edge<string>(_node1, _node2, isDirected: true);
            var edge2 = new Edge<string>(_node2, _node1);
