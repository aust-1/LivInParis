...
namespace LivInParisRoussilleTeynier.Infrastructure.Data;

/// <summary>
/// EF Core database context for the Liv’In Paris application.
/// </summary>
/// <remarks>
/// Initializes a new instance of <see cref="LivInParisContext"/>.
/// </remarks>
public class LivInParisContext(DbContextOptions<LivInParisContext> options) : DbContext(options)
{
    /// <summary>
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Individual>(e =>
        {
            ...
            e.HasIndex(i => i.PhoneNumber).IsUnique().HasDatabaseName("IX_Individual_PhoneNumber");
        ...
        modelBuilder.Entity<Review>(e =>
        {
            ...
            e.Property(r => r.ReviewerType).IsRequired().HasConversion<string>().HasMaxLength(20);
